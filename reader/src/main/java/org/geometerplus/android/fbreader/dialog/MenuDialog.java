...
public class MenuDialog extends Dialog {
  ...
  private void initView() {
    ...
    mIvMenuHeadBack = findViewById(R.id.id_menu_head_back);
  ...
  public void show() {
    ...
    if (mViewMenuBottomContainer != null) {
      mViewMenuBottomContainer.post(new Runnable() {
        @Override
        public void run() {
          ObjectAnimator animator = ObjectAnimator.ofFloat(mViewMenuBottomContainer, "translationY",
              mViewMenuBottomContainer.getMeasuredHeight(), 0);
  ...
  private void updatePreference() {
    if (myFBReaderApp != null) {
      int backgroundColor = ZLAndroidColorUtil
          .rgb(myFBReaderApp.ViewOptions.getColorProfile().MenuBackgroundOption.getValue());
      int textColor = ZLAndroidColorUtil
          .rgb(myFBReaderApp.ViewOptions.getColorProfile().MenuTextOption.getValue());
      ...
      if (ColorProfile.DAY.equals(myFBReaderApp.ViewOptions.ColorProfileName.getValue())) {
        ...
        mIvMenuHeadBookMark
            .setImageResource(R.drawable.ic_fbreader_menu_head_book_mark_unselected_day);
        mMenuBottomCatalogIv
            .setImageResource(R.drawable.ic_fbreader_menu_bottom_catalog_unselected_day);
        mMenuBottomCatalogTv.setTextColor(textColor);
        mMenuBottomProgressIv
            .setImageResource(R.drawable.ic_fbreader_menu_bottom_progress_unselected_day);
        mMenuBottomProgressTv.setTextColor(textColor);
        mMenuBottomSettingIv
            .setImageResource(R.drawable.ic_fbreader_menu_bottom_setting_unselected_day);
        mMenuBottomSettingTv.setTextColor(textColor);
        mMenuBottomLightIv
            .setImageResource(R.drawable.ic_fbreader_menu_bottom_light_unselected_day);
        ...
        mIvMenuHeadBookMark
            .setImageResource(R.drawable.ic_fbreader_menu_head_book_mark_unselected_night);
        mMenuBottomCatalogIv
            .setImageResource(R.drawable.ic_fbreader_menu_bottom_catalog_unselected_night);
        mMenuBottomCatalogTv.setTextColor(textColor);
        mMenuBottomProgressIv
            .setImageResource(R.drawable.ic_fbreader_menu_bottom_progress_unselected_night);
        mMenuBottomProgressTv.setTextColor(textColor);
        mMenuBottomSettingIv
            .setImageResource(R.drawable.ic_fbreader_menu_bottom_setting_unselected_night);
        mMenuBottomSettingTv.setTextColor(textColor);
        mMenuBottomLightIv
            .setImageResource(R.drawable.ic_fbreader_menu_bottom_light_unselected_night);
        mMenuBottomLightTv.setTextColor(textColor);
      }
  ...
  private void updateBookMarkStatus() {
    if (myFBReaderApp.checkCurrentPageHasBookMark()) {
      ...
      if (ColorProfile.DAY.equals(myFBReaderApp.ViewOptions.ColorProfileName.getValue())) {
        //日间模式
        mIvMenuHeadBookMark
            .setImageResource(R.drawable.ic_fbreader_menu_head_book_mark_selected_day);
      } else {
        //夜间模式
        mIvMenuHeadBookMark
            .setImageResource(R.drawable.ic_fbreader_menu_head_book_mark_selected_night);
      }
    } else {
      hasBookMark = false;
      if (ColorProfile.DAY.equals(myFBReaderApp.ViewOptions.ColorProfileName.getValue())) {
  ...
  private void selectSetting() {
    int backgroundColor = ZLAndroidColorUtil
        .rgb(myFBReaderApp.ViewOptions.getColorProfile().MenuBackgroundOption.getValue());
    int blackColor = ZLAndroidColorUtil
        .rgb(myFBReaderApp.ViewOptions.getColorProfile().BlackTextOption.getValue());
    int textColor = ZLAndroidColorUtil
        .rgb(myFBReaderApp.ViewOptions.getColorProfile().MenuSelectedTextOption.getValue());
    if (ColorProfile.DAY.equals(myFBReaderApp.ViewOptions.ColorProfileName.getValue())) {
      //日间模式
      mMenuBottomSettingIv
          .setImageResource(R.drawable.ic_fbreader_menu_bottom_setting_selected_day);
      mMenuBottomSettingTv.setTextColor(textColor);
      ...
      //夜间模式
      mMenuBottomSettingIv
          .setImageResource(R.drawable.ic_fbreader_menu_bottom_setting_selected_night);
      mMenuBottomSettingTv.setTextColor(textColor);
      mViewSettingContainer.setBackgroundColor(backgroundColor);
      mTvSettingTurnPage.setTextColor(blackColor);
      mTvSettingFont.setTextColor(blackColor);
  ...
  private void selectLight() {
    int backgroundColor = ZLAndroidColorUtil
        .rgb(myFBReaderApp.ViewOptions.getColorProfile().MenuBackgroundOption.getValue());
    int blackTextColor = ZLAndroidColorUtil
        .rgb(myFBReaderApp.ViewOptions.getColorProfile().BlackTextOption.getValue());
    int textColor = ZLAndroidColorUtil
        .rgb(myFBReaderApp.ViewOptions.getColorProfile().MenuSelectedTextOption.getValue());
    if (ColorProfile.DAY.equals(myFBReaderApp.ViewOptions.ColorProfileName.getValue())) {
  ...
  private void selectProgress() {
    ...
    if (ColorProfile.DAY.equals(myFBReaderApp.ViewOptions.ColorProfileName.getValue())) {
      //日间模式
      mMenuBottomProgressIv
          .setImageResource(R.drawable.ic_fbreader_menu_bottom_progress_selected_day);
      mMenuBottomProgressTv.setTextColor(textColor);
      ...
      //夜间模式
      mMenuBottomProgressIv
          .setImageResource(R.drawable.ic_fbreader_menu_bottom_progress_selected_night);
      mMenuBottomProgressTv.setTextColor(textColor);
      mViewProgressBottomContainer.setBackgroundColor(backgroundColor);
      mTvProgressTime.setTextColor(blackTextColor);
  ...
  private void updateProgressView() {
    ...
    mTvProgressProgress.setText(
        mContext.getString(R.string.fbreader_progress_tips, currentPosition, totalPage, percent)
            + "%");
    mProgressSeekBar.setMax(pagePosition.Total - 1);
  ...
  private void updateLightView() {
    ...
    mIvLightModeDaily
        .setImageResource(R.drawable.ic_fbreader_menu_bottom_light_mode_daily_unselected);
    mIvLightModeFresh
        .setImageResource(R.drawable.ic_fbreader_menu_bottom_light_mode_fresh_unselected);
    mIvLightModeYellow
        .setImageResource(R.drawable.ic_fbreader_menu_bottom_light_mode_yellow_unselected);
    mIvLightModeNight
        .setImageResource(R.drawable.ic_fbreader_menu_bottom_light_mode_night_unselected);
    ...
    if (ColorProfile.DAY.equals(myFBReaderApp.ViewOptions.ColorProfileName.getValue())) {
      ...
      if (color.equals(new ZLColor(Color.parseColor("#f4f4f4")))) {
        mIvLightModeDaily
            .setImageResource(R.drawable.ic_fbreader_menu_bottom_light_mode_daily_selected);
      } else if (color.equals(new ZLColor(Color.parseColor("#d6fde7")))) {
        mIvLightModeFresh
            .setImageResource(R.drawable.ic_fbreader_menu_bottom_light_mode_fresh_selected);
      } else if (color.equals(new ZLColor(Color.parseColor("#fff5e4")))) {
        mIvLightModeYellow
            .setImageResource(R.drawable.ic_fbreader_menu_bottom_light_mode_yellow_selected);
      } else if (color.equals(new ZLColor(Color.parseColor("#dbf1ff")))) {
        mIvLightModeEye
            .setImageResource(R.drawable.ic_fbreader_menu_bottom_light_mode_blue_selected);
      }
    } else {
      //夜间模式
      mIvLightModeNight
          .setImageResource(R.drawable.ic_fbreader_menu_bottom_light_mode_night_selected);
    }
  }
  ...
  private void initSettingView() {
    ...
    mTvSettingTurnPageShift = (TextView) findViewById(
        R.id.id_menu_bottom_setting_turning_page_shift);
    mTvSettingTurnPageSlide = (TextView) findViewById(
        R.id.id_menu_bottom_setting_turning_page_slide);
    ...
    mSettingSeekBar.setMax(
        myFBReaderApp.ViewOptions.getTextStyleCollection().getBaseStyle().FontSizeOption.MaxValue);
  ...
  private void updateSettingView() {
    int progress = myFBReaderApp.ViewOptions.getTextStyleCollection().getBaseStyle().FontSizeOption
        .getValue();
  ...
  private void updatePageTurningMode() {
    int selectedColor = ZLAndroidColorUtil
        .rgb(myFBReaderApp.ViewOptions.getColorProfile().MenuSelectedTextOption.getValue());
    int blackColor = ZLAndroidColorUtil
        .rgb(myFBReaderApp.ViewOptions.getColorProfile().BlackTextOption.getValue());
    ...
    int selectedBackground =
        ColorProfile.DAY.equals(myFBReaderApp.ViewOptions.ColorProfileName.getValue()) ?
            R.drawable.bg_fbreader_setting_turn_page_selected_day
            : R.drawable.bg_fbreader_setting_turn_page_selected_night;
