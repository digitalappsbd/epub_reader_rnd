...
public class OpenDictionaryActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myArticleView = findViewById(R.id.opendictionary_article_view);
		myTitleLabel = findViewById(R.id.opendictionary_title_label);
		myOpenDictionaryButton = findViewById(R.id.opendictionary_open_button);
	...
	private void setViewSize(int height, int gravity) {
		...
		TableRow bottomRow = findViewById(R.id.bottom_row);
		TableRow topRow = findViewById(R.id.top_row);
