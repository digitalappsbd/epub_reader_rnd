...
package com.digitalappsbd.app.epurreader.opds
...
class OPDSListActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    if (preferences.getInt(VERSION_KEY, 0) < version) {
      ...
      val R2TestCatalog =
        OPDSModel("R2 Reader Test Catalog", "https://d2g.dita.digital/opds/collections/10040", 1)
      ...
      val SEBCatalog =
        OPDSModel("Standard eBooks Catalog", " https://standardebooks.org/opds/all", 1)
...
private class OPDSViewAdapter(
  private val activity: Activity,
  private val list: MutableList<OPDSModel>
) : RecyclerView.Adapter<OPDSViewAdapter.ViewHolder>() {
