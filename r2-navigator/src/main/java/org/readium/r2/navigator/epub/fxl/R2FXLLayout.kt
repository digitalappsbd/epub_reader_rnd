...
class R2FXLLayout : FrameLayout {
  ...
  internal inner class GestureListener : ScaleGestureDetector.OnScaleGestureListener,
  ...
  class TapInfo(r2FXLLayout: R2FXLLayout, e: MotionEvent) {
    ...
    companion object {
      ...
      private const val STRING_FORMAT =
  ...
  private inner class SimpleOnGlobalLayoutChangedListener :
