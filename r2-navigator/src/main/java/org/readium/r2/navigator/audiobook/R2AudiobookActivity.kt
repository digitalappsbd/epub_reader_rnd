...
open class R2AudiobookActivity : AppCompatActivity(), CoroutineScope, IR2Activity,
  MediaPlayerCallback, VisualNavigator {
  ...
  private fun updateUI() {
    ...
    chapterTime!!.text = String.format(
      "%d:%d",
    ...
    progressTime!!.text = String.format(
      "%d:%d",
